...
**1. `infra/variables.tf` — project name**
...
This single value drives all Azure resource names: the resource group (`rg-<project>`), the container registry, the container instance, the managed identity, and the DNS label.

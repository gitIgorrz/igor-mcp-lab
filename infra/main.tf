...
# NOTE: The constrained User Access Administrator role assignment for the
# service principal is NOT managed here. It is a one-time manual prerequisite
# created by the subscription owner before first deploy — see README.md and
# docs/getting-started.md for the exact az role assignment create command.
# It lives at the subscription level and persists across deploy/destroy cycles.
